...
VALUES
  ...
  ('06eebc99-9c0b-4ef8-bb6d-6bb9bd380a17', 'First Meeting', 'Introduce yourself to a new friend', '🤝', 'New Friend', 'Self', 'Hi! Nice to meet you. I''m Alex.', 'Social', 'Easy', 'Get to know each other', 'assets/images/scenes/handshake_3d.png', 4294190581, 'en-US'),
  ('17eebc99-9c0b-4ef8-bb6d-6bb9bd380a18', 'Hotel Check-in', 'Check in to your hotel room', '🏨', 'Receptionist', 'Guest', 'Welcome! Do you have a reservation with us?', 'Travel', 'Medium', 'Successfully check in', 'assets/images/scenes/hotel_3d.png', 4292937722, 'en-US'),

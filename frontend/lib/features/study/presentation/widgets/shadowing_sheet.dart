...
class _ShadowingSheetState extends ConsumerState<ShadowingSheet>
  ...
  /// Get localized prosody feedback
  (String, String) _getLocalizedProsodyFeedback({
    ...
    if (score >= 80) {
      statusText = l10n.feedback_greatStatus;
      detailedTip = isQuestion
          ? l10n.feedback_greatTipQuestion
          : l10n.feedback_greatTipDefault;
    } else if (score >= 60) {
      statusText = l10n.feedback_goodStatus;
      if (isQuestion) {
        detailedTip = l10n.feedback_goodTipQuestion;
      } else if (hasExclamation) {
        detailedTip = l10n.feedback_goodTipExclamation;
      } else {
        detailedTip = l10n.feedback_goodTipDefault;
      }
    } else {
      statusText = l10n.feedback_flatStatus;
      if (isQuestion) {
        detailedTip = l10n.feedback_flatTipQuestion;
      } else if (hasExclamation) {
        detailedTip = l10n.feedback_flatTipExclamation;
      } else {
        detailedTip = l10n.feedback_flatTipDefault;
      }
    }
